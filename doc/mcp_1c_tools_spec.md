...
| 4 | `run_1c_query` | Выполнить безопасный read-only запрос 1С | P0 |
| 5 | `validate_1c_query` | Проверить запрос 1С до выполнения | P0 |
| 6 | `get_1c_query_guidance` | Получить универсальные подсказки по языку запросов 1С | P0 |
