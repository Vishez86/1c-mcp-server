# Спецификация MCP-сервера для 1С: 34 read-only tools
...
1. Все 34 tools возвращаются в `tools/list`.
...
Ожидание: `ok=true`, `read_only=true`, список tools содержит 34 tools.
