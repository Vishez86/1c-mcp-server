...
Профилирование: куда уходит время вызова, какие инструменты медленные, сколько вызовов завершилось отказом. Связка ответа с записью журнала — по `correlation_id`.
