# Спецификация MCP-сервера для 1С: 35 read-only tools
...
1. Все 35 tools возвращаются в `tools/list`.
...
Ожидание: `ok=true`, `read_only=true`, список tools содержит 35 tools.
