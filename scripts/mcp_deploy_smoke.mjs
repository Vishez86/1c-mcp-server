...
const MODULE_MARKERS = [
  ...
  },
  {
    ...
    // since=976c52e: ревизия поднята до 2026-08-14.4 (ранний выход маскирования
    // и снятие служебного ключа). Довод тот же: ревизия живёт в этом модуле,
    // сверка `код == контур` доказывает его свежесть точно.
    since: "976c52e",
  ...
  },
  {
    ...
    // since=976c52e: и ревизией .14.4 (ранний выход маскирования).
