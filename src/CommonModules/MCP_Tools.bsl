...
// Главный dispatcher.
Функция ВыполнитьИнструмент(ИмяТула, Аргументы, РежимРезультата = "") Экспорт
...
Функция Tool_list_1c_language_doc_topics(РежимРезультата = "")
	Props = Новый Структура;
	Props.Вставить("version", _Схема("string", , "Версия платформы. Поддерживается 8.3.27; по умолчанию 8.3.27."));
	...
	Возврат _Tool("list_1c_language_doc_topics",
		...
		"Возвращает компактную карту встроенной документации 1С 8.3.27 без полного текста.",
		Props, Неопределено, РежимРезультата);
КонецФункции
...
Функция Tool_search_1c_language_docs(РежимРезультата = "")
	...
	Возврат _Tool("search_1c_language_docs",
		...
		"Ищет релевантные секции встроенной документации 1С 8.3.27 и возвращает короткие выдержки.",
		Props, _Required("query"), РежимРезультата);
КонецФункции
...
Функция Tool_read_1c_language_doc_section(РежимРезультата = "")
	...
	Возврат _Tool("read_1c_language_doc_section",
		...
		"Возвращает одну секцию встроенной документации 1С 8.3.27 с лимитом размера.",
		Props, Неопределено, РежимРезультата);
КонецФункции
