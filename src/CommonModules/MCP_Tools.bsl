...
Функция Tool_get_database_passport_full(РежимРезультата = "")
	Возврат _Tool("get_database_passport_full",
		...
		+ " По каждому виду два числа: total — всего в конфигурации, allowed — доступно по allowlist"
		+ " и правам 1С; allowed сходится с total_estimated у list_metadata_objects по тому же виду."
